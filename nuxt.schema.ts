        ...
        picture: group({
          ...
          fields: {
            dark: field({
              ...
              icon: 'lucide:moon',
              default: 'https://media.licdn.com/dms/image/v2/D5603AQFedNqNnwFFHQ/profile-displayphoto-shrink_200_200/B56ZU.JmabGUAY-/0/1740504459429?e=2147483647&v=beta&t=KKkdas9mCmKVZYvzgmCfEwFB6SfoiymQnf9hxJlmIvc'
            }),
            light: field({
              type: 'string',
              title: 'Light mode',
